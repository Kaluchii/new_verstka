    ...
    <div class="personal-area">
        <div class="personal-area__container">
            <div class="personal-area__menu menu">
                <ul class="menu__list">
                    <li class="menu__item is-active"><a href="/loan_active" class="menu__link link">Ваш займ</a></li>
            ...
            <div class="personal-area__small-title">Ваш займ <span class="personal-area__title-select personal-area__title-select--overdue">просрочен</span>, начисляется пеня</div>
