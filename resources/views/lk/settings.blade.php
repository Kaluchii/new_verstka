...
@section('content')
    <main class="personal-area">
        <div class="personal-area__container">
            ...
            <div class="personal-area__info-block-wrap">
            ...
            <div class="personal-area__info-block-wrap">
                <div class="personal-area__info-block info-block">
                    <div class="info-block__top">
                        <p class="info-block__title title-l2">Адрес</p>
                        <div class="info-block__btn-wrap">
                            <a href="#" class="info-block__btn button button--t-grey"><span class="button__text">Изменить</span></a>
                        </div>
                    </div>
                    <div class="info-block__data-list data-list">
                        <div class="data-list__item data-list__item--full">
                            <div class="data-list__item-name">Адрес прописки</div>
                            <div class="data-list__item-value">г.Алматы, ул. Ауэзова, д. 48, кв.8</div>
                        </div>
                        <div class="data-list__item data-list__item--full">
                            <div class="data-list__item-name">Адрес проживания</div>
                            <div class="data-list__item-value">г.Алматы, ул. Ауэзова, д. 48, кв.8</div>
                        </div>
                    </div>
                </div>
