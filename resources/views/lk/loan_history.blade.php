...
@section('content')
    <main class="personal-area">
        <div class="personal-area__container">
            ...
            <ul class="personal-area__history-loans history-loans">
                {{--<li class="history-loans__row history-loans__row--no-underline">
                    <p class="history-loans__no-loans-text">Займы отсутствуют</p>
                </li>--}}
                <li class="history-loans__row">
