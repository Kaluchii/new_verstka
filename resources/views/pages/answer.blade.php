...
@section('item')
    <div class="item__answer answer">
        <div class="answer__col-1">
            <h1 class="answer__title">Вопрос-ответ</h1>
                    ...
                    <ol class="answer__question-list hidden">
                        <li class="answer__question-list-item">
                            ...
                            <div class="answer__question-item-text text-block hidden">
                                ...
                                регионе Казахстана. Для оформления займа потребуется
                    ...
                    <ol class="answer__question-list hidden">
                        ...
                        <li class="answer__question-list-item">
                            ...
                            <div class="answer__question-item-text text-block hidden">
                                ...
                                отсутствуют. Услуги предоставляются прозрачно:
                                вы берете займ на тех условиях, что видите на сайте.
                                Пожалуйста, внимательно изучите оферту. Мы подробно
                                ответим на все вопросы и приведем примеры.
                            </div>
                        </li>
                        <li class="answer__question-list-item">
                            ...
                            <div class="answer__question-item-text text-block hidden">
                                ...
                                <br><br>
                                Заполните личные данные, укажите номер счета или банковской
                                карты для получения денег. Получив заявку, оператор свяжется
                                с вами по телефону, чтобы подтвердить займ. В случае одобрения,
                                деньги поступят в течение 5 минут на карту или в течение рабочего
                                дня при получении на счет.
                            </div>
                        </li>
                        <li class="answer__question-list-item">
                            ...
                            <div class="answer__question-item-text text-block hidden">
                                ...
                                в выходные, получить займ можно только на карту.
                            </div>
                        </li>
                        <li class="answer__question-list-item">
                        ...
                        <li class="answer__question-list-item">
                            ...
                            <div class="answer__question-item-text text-block hidden">
                                ...
                                на выходных, она будет рассмотрена в первую очередь в рабочее время.
                            </div>
                        </li>
                        <li class="answer__question-list-item">
                            ...
                            <div class="answer__question-item-text text-block hidden">
                                ...
                                <br>
                                • Есть задолженности по другим займам;
                                <br>
                        ...
                        <li class="answer__question-list-item">
                            ...
                            <div class="answer__question-item-text text-block hidden">
                                ...
                                приходит, свяжитесь со службой поддержки по номеру +7 (727) 350-50-33.
                            </div>
                        </li>
                        <li class="answer__question-list-item">
                            ...
                            <div class="answer__question-item-text text-block hidden">
                                ...
                                отметьте, что письма сервиса не являются спамом.
                            </div>
                        </li>
                        <li class="answer__question-list-item">
                            ...
                            <div class="answer__question-item-text text-block hidden">
                                ...
                                Вы можете связаться со службой поддержки по номеру
                                +7 727 350 50 33 или в WhatsApp +7 771 395-90-07.
                            </div>
                        </li>
                        <li class="answer__question-list-item">
                    ...
                    <ol class="answer__question-list hidden">
                        <li class="answer__question-list-item">
                            ...
                            <div class="answer__question-item-text text-block hidden">
                                ...
                                После одобрения заявки, мы моментально отправляем деньги по
                                указанному вами способу получения. Начисление денег на банковский
                                счет и счет «КазПочты» происходит в течение дня. Начисление денег
                                на банковскую карту происходит в течение 10 минут.
                            </div>
                        </li>
                        <li class="answer__question-list-item">
                            <h3 class="answer__question-list-subtitle link">Когда поступят деньги?</h3>
                            <div class="answer__question-item-text text-block hidden">
                                ...
                                денежные начисления от всех источников, кроме государства.
                            </div>
                        </li>
                        <li class="answer__question-list-item">
                            ...
                            <div class="answer__question-item-text text-block hidden">
                                ...
                                В случае одобрения, мы отправляем деньги в течение 15 минут.
                                Получить займ можно в любом отделении «Казпочты» по всему Казахстану.
                                <br><br>
                                Как узнать IBAN-номер счета?
                                <br>
                                • В контакт-центре по номеру 1499;
                                <br>
                        ...
                        <li class="answer__question-list-item">
                            ...
                            <div class="answer__question-item-text text-block hidden">
                                ...
                                о заключении сделки (оферте). Если вы нашли ошибку
                                данных в договоре, обратитесь в службу поддержки +7 771 395-90-07
                            </div>
                        </li>
                    </ol>
                </li>
                    ...
                    <ol class="answer__question-list hidden">
                        ...
                        <li class="answer__question-list-item">
                            ...
                            <div class="answer__question-item-text text-block hidden">При погашении займа, вы можете оплатить банковской картой или через терминалы моментальной оплаты QIWI и Касса24.
                                ...
                                <ol>
                                    <li>Войдите в личный кабинет и нажмите «Погасить Займ».</li>
                                ...
                                <br>
                                <br>Погасить займ банковским переводом вы можете в любом банке РК. Для этого вам нужно прийти в кассу и оплатить нужную сумму по следующим реквизитам:
                                <ul>
                                    ...
                                    <li>КБЕ: 15</li>
                                    <li>КНП: 421</li>
                                </ul>В назначении платежа укажите «Погашение займа», ваш ИИН и ФИО.
                                ...
                                При оплате займа учитывайте комиссию до 2% за оплату через терминалы QIWI.
                                В разделе оплаты указана максимальная сумма для разовой оплаты через терминал. Если сумма к погашению займа превышает лимит, потребуется внести несколько платежей на меньшую сумму.
                                <br>
                                <br>
                                ...
                                При оплате займа учитывайте комиссию до 2.5% за оплату через терминал Касса24.
                                В разделе оплаты указана максимальная сумма для разовой оплаты через терминал. Если сумма к погашению займа превышает лимит, потребуется внести несколько платежей на меньшую сумму.
                                <br>
                                <br>
                        ...
                        <li class="answer__question-list-item">
                            ...
                            <div class="answer__question-item-text text-block hidden">
                                ...
                                только минимальный срок оформления займа — 5 дней.
                            </div>
                        </li>
                        <li class="answer__question-list-item">
                    ...
                    <ol class="answer__question-list hidden">
                        <li class="answer__question-list-item">
                            ...
                            <div class="answer__question-item-text text-block hidden">
                                ...
                                <br>
                                • Согласитесь с офертой на продление Договора займа.
                                <br>
                                • Поставьте галочку в согласии с офертой на продление Договора займа.
                                <br>
                                • На ваш телефон придет SMS с кодом. В появившемся поле введите код из SMS.
                                <br>
                                • Нажмите «Оплатить продление»» и выберите удобный для вас способ оплаты.
                                <br>
                                • Оплатите услугу продления в течение суток.
                                <br>
                                • Вы можете отказаться от пролонгации нажав кнопку «Отказаться от продления».
                            </div>
                        </li>
                        <li class="answer__question-list-item">
        ...
        <div class="answer__col-2">
            <div class="answer__nav-block">
                <ul class="answer__nav-list">
                    <li class="answer__nav-list-item">
                        <a class="answer__nav-link link" href="#">Как мы работаем</a>
                    </li>
                    <li class="answer__nav-list-item">
                        <a class="answer__nav-link link" href="#">Как оформить займ</a>
                    </li>
                    <li class="answer__nav-list-item">
                        <a class="answer__nav-link link" href="#">Как погасить займ</a>
                    </li>
                    <li class="answer__nav-list-item">
                        <a class="answer__nav-link link" href="#">Вопрос-ответ</a>
                    </li>
                </ul>
            </div>
